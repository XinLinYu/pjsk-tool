...
import com.projectsekai.config.JedisPoolUtils;
...
public class RedisUtil {
            ...
            synchronized (JedisPool.class) {
                if (jedisPool == null) {
                    ...
                    jedisPool = new JedisPool(config,
                            ...
                            Integer.parseInt(properties.getProperty("port")), 10000, properties.getProperty("password"), Integer.parseInt(properties.getProperty("database")));
                }
            }
        }
        return jedisPool;
    ...
    public String get(String key, int indexdb) {
        ...
        try {
            ...
            returnResource(getInstance(), jedis);
        }
        return value;
    }
